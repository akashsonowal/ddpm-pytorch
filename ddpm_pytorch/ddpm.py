...
class DenoiseDiffusion:
    ...
    def q_xt_x0(  # forward noise from x0 to all timestamps included in the batch t
        self, x0: torch.Tensor, t: torch.Tensor
    ) -> Tuple[torch.Tensor, torch.Tensor]:
        mean = gather(self.alpha_bar, t) ** 0.5 * x0  # mean has to be broadcasted
        var = 1 - gather(self.alpha_bar, t)  # var has to be broadcasted
        return mean, var
